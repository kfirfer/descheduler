...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeResourceActualUtilizationThresholds)(nil), (*api.NodeResourceActualUtilizationThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NodeResourceActualUtilizationThresholds_To_api_NodeResourceActualUtilizationThresholds(a.(*NodeResourceActualUtilizationThresholds), b.(*api.NodeResourceActualUtilizationThresholds), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NodeResourceActualUtilizationThresholds)(nil), (*NodeResourceActualUtilizationThresholds)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NodeResourceActualUtilizationThresholds_To_v1alpha1_NodeResourceActualUtilizationThresholds(a.(*api.NodeResourceActualUtilizationThresholds), b.(*NodeResourceActualUtilizationThresholds), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_NodeResourceActualUtilizationThresholds_To_api_NodeResourceActualUtilizationThresholds(in *NodeResourceActualUtilizationThresholds, out *api.NodeResourceActualUtilizationThresholds, s conversion.Scope) error {
...
// Convert_v1alpha1_NodeResourceActualUtilizationThresholds_To_api_NodeResourceActualUtilizationThresholds is an autogenerated conversion function.
func Convert_v1alpha1_NodeResourceActualUtilizationThresholds_To_api_NodeResourceActualUtilizationThresholds(in *NodeResourceActualUtilizationThresholds, out *api.NodeResourceActualUtilizationThresholds, s conversion.Scope) error {
	return autoConvert_v1alpha1_NodeResourceActualUtilizationThresholds_To_api_NodeResourceActualUtilizationThresholds(in, out, s)
}

func autoConvert_api_NodeResourceActualUtilizationThresholds_To_v1alpha1_NodeResourceActualUtilizationThresholds(in *api.NodeResourceActualUtilizationThresholds, out *NodeResourceActualUtilizationThresholds, s conversion.Scope) error {
...
// Convert_api_NodeResourceActualUtilizationThresholds_To_v1alpha1_NodeResourceActualUtilizationThresholds is an autogenerated conversion function.
func Convert_api_NodeResourceActualUtilizationThresholds_To_v1alpha1_NodeResourceActualUtilizationThresholds(in *api.NodeResourceActualUtilizationThresholds, out *NodeResourceActualUtilizationThresholds, s conversion.Scope) error {
	return autoConvert_api_NodeResourceActualUtilizationThresholds_To_v1alpha1_NodeResourceActualUtilizationThresholds(in, out, s)
}
...
func autoConvert_v1alpha1_StrategyParameters_To_api_StrategyParameters(in *StrategyParameters, out *api.StrategyParameters, s conversion.Scope) error {
	...
	out.NodeResourceActualUtilizationThresholds = (*api.NodeResourceActualUtilizationThresholds)(unsafe.Pointer(in.NodeResourceActualUtilizationThresholds))
...
func autoConvert_api_StrategyParameters_To_v1alpha1_StrategyParameters(in *api.StrategyParameters, out *StrategyParameters, s conversion.Scope) error {
	...
	out.NodeResourceActualUtilizationThresholds = (*NodeResourceActualUtilizationThresholds)(unsafe.Pointer(in.NodeResourceActualUtilizationThresholds))
	out.NodeAffinityType = *(*[]string)(unsafe.Pointer(&in.NodeAffinityType))
